                ...
                <div className="row">
                    ...
                    <div className="col-md-4 mb-4">
                        ...
                        <ul className="list-unstyled">
                            <li className="mb-2">
                                <a href="/" className="text-muted text-decoration-none">Trang Chủ</a>
                            </li>
                            <li className="mb-2">
                                <a href="/loai-phim/phim-le" className="text-muted text-decoration-none">Phim Lẻ</a>
                            </li>
                            <li className="mb-2">
                                <a href="/loai-phim/phim-bo" className="text-muted text-decoration-none">Phim Bộ</a>
                            </li>
                            <li className="mb-2">
                                <a href="/the-loai/phim-hoat-hinh" className="text-muted text-decoration-none">Phim Hoạt Hình</a>
                            </li>
                        </ul>
                    </div>
