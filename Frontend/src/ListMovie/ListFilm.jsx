...
import { SearchMovieByCategory } from '../apis/movieAPI';
...
const ListFilm = () => {
    ...
    const fetchMovies = async (page) => {   
        ...
        try {
            ...
            //     }
            // });
            const response = await SearchMovieByCategory(category, page, itemsPerPage);
    ...
    const firstMovieCategories = currentMovies?.length > 0 ? currentMovies[0].nameCategories.split(', ') : [];
