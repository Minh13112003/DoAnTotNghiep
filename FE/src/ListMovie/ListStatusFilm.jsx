...
const ListStatusFilm = () => {
    ...
    useEffect(() => {
        const fetchMovies = async () => {
            const response = await axios.get(`http://localhost:5285/api/movie/GetMovieByStatus/${movieStatusSlug}`);
            ...
            <div className='container'>
                <div className='row'>
                    <div className="d-flex justify-content-between align-items-center">
                        <h4 className="ms-2"><b>Danh sách phim {movies.length > 0 ? movies[0].statusText : 'Phim'}</b></h4>
                    </div>
                </div>
